...
class GoogleEnum(enumratorBaseThreaded):
    def __init__(self, domain, subdomains=None, q=None, silent=False, verbose=True):
        ...
        base_url = "https://www.google.com/search?q={query}&source=hp&ei=s9GKY_vgAdSOseMP9uar8A8&iflsig=AJiK0e8AAAAAY4rfw91-TmVRMyu-DNAW5q73m2w92K4a&ved=0ahUKEwi7hoiyz9z7AhVUR2wGHXbzCv4Q4dUDCAk&uact=5&oq={query}&gs_lcp=Cgdnd3Mtd2l6EAMyBggAEB4QDTIGCAAQHhANMgYIABAeEA0yBggAEB4QDTIICAAQHhAPEA0yBggAEBYQHjoICAAQjwEQ6gI6CAguEI8BEOoCULYDWLYDYJ4IaAFwAHgAgAGjAYgBowGSAQMwLjGYAQCgAQKgAQGwAQo&sclient=gws-wiz"
